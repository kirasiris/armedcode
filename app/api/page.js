				...
				<section className="bg-black text-bg-dark py-5">
					<div className="container">
							...
							<div className="card-body">
								...
								<div className="row mb-3">
									<div className="col-lg-6">
										...
										<p className="text-secondary">
											Information about NFA item ownership is sensitive and
									...
									<div className="col-lg-12">
										<div className="bg-dark p-4 rounded">
											<h4>Our Solution</h4>
											<p className="text-secondary">
												We&apos;ve developed a private, secure API that allows
												FFL holders and collectors to manage their NFA items
												while maintaining privacy and security. Our API
												provides:
											</p>
											<ul className="list-unstyled">
												...
												<li className="d-flex justify-content-start">
													...
													<span>
														Your data remains private and is never shared
													</span>
												</li>
												<li className="d-flex justify-content-start">
						...
						<div className="card border border-1 my-border-color bg-black text-bg-dark mb-3">
							...
							<div className="card-body">
								<p className="text-secondary">
									To use our API, you&apos;ll need to authenticate first to
									receive your AUTHENTICATION KEY. You will then be required to
									purchase a membership plan that fits your needs. Each plan
									provides different levels of API access.
								</p>
								<div className="row">
									<div className="col-lg-12 mb-3">
										<div className="bg-dark p-4 rounded">
											...
											<p className="text-secondary">
												For security and compliance reasons, all users must
												complete the following steps:
											</p>
											<ol className="list-unstyled">
												<li>
													1. Create an account or sign in to your existing
													account
												</li>
												<li>
													2. Verify and activate your account to sign in to
													system
												</li>
												<li>
													3. Select a membership tier that fits your needs
												</li>
												<li>
									...
									<div className="col-lg-12">
										...
										<p className="text-secondary">
											Include your SECRET API key in the headers of all
											requests:
										</p>
										<div className="bg-dark p-4 rounded">
											<div className="d-flex gap-2">
