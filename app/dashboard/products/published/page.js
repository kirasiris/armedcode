...
const DashboardProductsPublishedIndex = async ({ params, searchParams }) => {
	...
	const draftIt = async (id) => {
		...
		revalidatePath(
			`/dashboard/products/published?page=${page}&limit=${limit}&sort=${sort}`
		);
	};
...
export default DashboardProductsPublishedIndex;
