...
const DashboardProductsTrashedIndex = async ({ params, searchParams }) => {
	...
	const draftIt = async (id) => {
		...
		revalidatePath(
			`/dashboard/products/trashed?page=${page}&limit=${limit}&sort=${sort}`
		);
	};
...
export default DashboardProductsTrashedIndex;
