...
const DashboardProductsDraftIndex = async ({ params, searchParams }) => {
	...
	const draftIt = async (id) => {
		...
		revalidatePath(
			`/dashboard/products/draft?page=${page}&limit=${limit}&sort=${sort}`
		);
	};
...
export default DashboardProductsDraftIndex;
