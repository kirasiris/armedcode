...
const DashboardCompaniesDraftIndex = async ({ params, searchParams }) => {
	...
	const draftIt = async (id) => {
		...
		revalidatePath(
			`/dashboard/companies/draft?page=${page}&limit=${limit}&sort=${sort}`
		);
	};
...
export default DashboardCompaniesDraftIndex;
