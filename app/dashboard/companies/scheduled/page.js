...
const DashboardCompaniesScheduledIndex = async ({ params, searchParams }) => {
	...
	const draftIt = async (id) => {
		...
		revalidatePath(
			`/dashboard/companies/scheduled?page=${page}&limit=${limit}&sort=${sort}`
		);
	};
...
export default DashboardCompaniesScheduledIndex;
