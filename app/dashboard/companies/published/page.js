...
const DashboardCompaniesPublishedIndex = async ({ params, searchParams }) => {
	...
	const draftIt = async (id) => {
		...
		revalidatePath(
			`/dashboard/companies/published?page=${page}&limit=${limit}&sort=${sort}`
		);
	};
	...
	return (
		<>
			<DashboardStatusesMenu
				...
				publishedLink="/dashboard/companies/published"
				draftLink="/dashboard/companies/draft"
				scheduledLink="/dashboard/companies/scheduled"
				trashedLink="/dashboard/companies/trashed"
				categoriesLink=""
				categoryType=""
			/>
...
export default DashboardCompaniesPublishedIndex;
