...
const DashboardCompaniesTrashedIndex = async ({ params, searchParams }) => {
	...
	const draftIt = async (id) => {
		...
		revalidatePath(
			`/dashboard/companies/trashed?page=${page}&limit=${limit}&sort=${sort}`
		);
	};
...
export default DashboardCompaniesTrashedIndex;
