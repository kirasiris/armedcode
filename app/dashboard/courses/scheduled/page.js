...
const DashboardCoursesScheduledIndex = async ({ params, searchParams }) => {
	...
	const draftIt = async (id) => {
		...
		revalidatePath(
			`/dashboard/courses/scheduled?page=${page}&limit=${limit}&sort=${sort}`
		);
	};
...
export default DashboardCoursesScheduledIndex;
