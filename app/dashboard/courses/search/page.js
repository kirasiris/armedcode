...
const DashboardCoursesSearchIndex = async ({ params, searchParams }) => {
	...
	const draftIt = async (id) => {
		...
		revalidatePath(
			`/dashboard/courses/search?keyword=${keyword}&page=${page}&limit=${limit}&sort=${sort}`
		);
	};
...
export default DashboardCoursesSearchIndex;
