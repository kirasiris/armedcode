...
const DashboardCoursesTrashedIndex = async ({ params, searchParams }) => {
	...
	const draftIt = async (id) => {
		...
		revalidatePath(
			`/dashboard/courses/trashed?page=${page}&limit=${limit}&sort=${sort}`
		);
	};
...
export default DashboardCoursesTrashedIndex;
