...
const DashboardCoursesPublishedIndex = async ({ params, searchParams }) => {
	...
	const draftIt = async (id) => {
		...
		revalidatePath(
			`/dashboard/courses/published?page=${page}&limit=${limit}&sort=${sort}`
		);
	};
...
export default DashboardCoursesPublishedIndex;
