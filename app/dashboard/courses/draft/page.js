...
const DashboardCoursesDraftIndex = async ({ params, searchParams }) => {
	...
	const draftIt = async (id) => {
		...
		revalidatePath(
			`/dashboard/courses/draft?page=${page}&limit=${limit}&sort=${sort}`
		);
	};
...
export default DashboardCoursesDraftIndex;
