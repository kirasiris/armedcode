...
const DashboardRealEstatesTrashedIndex = async ({ params, searchParams }) => {
	...
	const draftIt = async (id) => {
		...
		revalidatePath(
			`/dashboard/realestates/trashed?page=${page}&limit=${limit}&sort=${sort}`,
		);
	};
...
export default DashboardRealEstatesTrashedIndex;
