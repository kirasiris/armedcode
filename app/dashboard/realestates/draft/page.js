...
const DashboardRealEstatesDraftIndex = async ({ params, searchParams }) => {
	...
	const draftIt = async (id) => {
		...
		revalidatePath(
			`/dashboard/realestates/draft?page=${page}&limit=${limit}&sort=${sort}`,
		);
	};
...
export default DashboardRealEstatesDraftIndex;
