...
const DashboardRealEstatesIndex = async ({ params, searchParams }) => {
	...
	const draftIt = async (id) => {
		...
		revalidatePath(
			`/dashboard/realestates?page=${page}&limit=${limit}&sort=${sort}`,
		);
	};
...
export default DashboardRealEstatesIndex;
