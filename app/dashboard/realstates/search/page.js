...
const DashboardRealStatesSearchIndex = async ({ params, searchParams }) => {
	...
	const draftIt = async (id) => {
		...
		revalidatePath(
			`/dashboard/realstates/search?keyword=${keyword}&page=${page}&limit=${limit}&sort=${sort}`
		);
	};
...
export default DashboardRealStatesSearchIndex;
