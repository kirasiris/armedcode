...
const DashboardRealStatesScheduledIndex = async ({ params, searchParams }) => {
	...
	const draftIt = async (id) => {
		...
		revalidatePath(
			`/dashboard/realstates/scheduled?page=${page}&limit=${limit}&sort=${sort}`
		);
	};
...
export default DashboardRealStatesScheduledIndex;
