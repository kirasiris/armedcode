...
const DashboardRealStatesPublishedIndex = async ({ params, searchParams }) => {
	...
	const draftIt = async (id) => {
		...
		revalidatePath(
			`/dashboard/realstates/published?page=${page}&limit=${limit}&sort=${sort}`
		);
	};
...
export default DashboardRealStatesPublishedIndex;
